...
function ScanHistoryPanel({
  ...
  onCompare,
  currentScanId,
}: Omit<ScanHistoryProps, "isOpen">) {
  const [history, setHistory] = useState<SavedScan[]>(() => getHistory());
        ...
        <div className="flex-1 overflow-y-auto">
          {history.length === 0 ? (
            <div className="flex flex-col items-center justify-center h-full text-center px-8">
              ...
              <p className="text-text-secondary font-medium">No saved scans yet</p>
                      ...
                      <div className="flex items-start justify-between gap-3">
                        <div className="flex-1 min-w-0">
                          <div className="flex items-center gap-2 mb-1.5">
                            ...
                            <span
                              ...
                              style={{ color: getScoreColor(entry.totalScore) }}
                            >
                          ...
                          <p className="text-sm text-foreground truncate">{entry.cpuName}</p>
                          <p className="text-xs text-text-secondary truncate">{entry.gpuName}</p>
                        </div>
                        ...
                        {!compareMode && (
                          <button
                            ...
                            aria-label={
                              confirmDelete === entry.id ? "Confirm delete" : "Delete scan"
                            }
                          >
